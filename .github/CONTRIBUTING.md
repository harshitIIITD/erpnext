...
Thank you for your interest in raising an Issue with FashionFlow. An Issue could mean a bug report or a request for a missing feature. By raising a bug report, you are contributing to the development of FashionFlow and this is the first step of participating in the community. Bug reports are very helpful for developers as they quickly fix the issue before other users start facing it.
...
The Issue list is not the right place to ask a question or start a general discussion. If you want to do that, then the right place is the GitHub discussions [https://github.com/harshitIIITD/erpnext/discussions](https://github.com/harshitIIITD/erpnext/discussions).
